...
export default function HubDashboard() {
  ...
  const handleInvitationAccepted = () => {
    setLatestFeedback(makeFeedback("Invitation accepted. Welcome to the cooperative."));
    setEntryState("member");
  };
  ...
  return (
    <div className="space-y-8 px-4 py-6 md:px-6 lg:px-8">
      ...
      <div className="flex gap-4 flex-wrap text-sm text-slate-400">
        ...
        <a href="#learning-history">Learning History</a>
      ...
      <div id="ielts">
        <IELTSSection isMember={isMember} />
      </div>

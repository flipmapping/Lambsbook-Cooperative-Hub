 ...
 *
 * Current stage:
 * - persistent pair is authoritative once bootstrapped
 * - refresh is deliberately not performed here until the live OAuth
 *   response contract is wired
 * - callers must never read ZALO_ZNS_ACCESS_TOKEN directly
 */

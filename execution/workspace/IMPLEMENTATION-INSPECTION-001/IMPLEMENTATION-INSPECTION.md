...
# IMPLEMENTATION-INSPECTION-001

Created
-------

2026-07-30 02:22 UTC

Mission
-------

Establish the implementation baseline from the live repository before any
new production mutation.

Inspection Scope
----------------

The inspection is limited to identifying implementation surfaces.
...
client/src/components/AdvantagesSection.tsx
client/src/components/ContactSection.tsx
client/src/components/CountriesSection.tsx
client/src/components/EB3Categories.tsx
...
client/src/components/JobCategoriesSection.tsx
...
client/src/components/StudyAbroadSection.tsx
client/src/components/SuccessStories.tsx
...
client/src/components/examples/AdvantagesSection.tsx
client/src/components/examples/ContactSection.tsx
client/src/components/examples/CountriesSection.tsx
client/src/components/examples/EB3Categories.tsx
client/src/components/examples/FAQSection.tsx
client/src/components/examples/Footer.tsx
client/src/components/examples/Header.tsx
client/src/components/examples/HeroSection.tsx
client/src/components/examples/JobCategoriesSection.tsx
client/src/components/examples/ProcessSection.tsx
client/src/components/examples/ServicesSection.tsx
client/src/components/examples/StudyAbroadSection.tsx
client/src/components/examples/SuccessStories.tsx
...
client/src/components/notifications/ToggleControl.tsx
...
client/src/lib/imageConstants.ts
client/src/lib/lambsbookTutoringContent.ts
client/src/lib/learning/types.ts
...
server/services/admissions.ts.pre-ge-comm-001-g20
server/services/admissions.ts.pre-ge-rmp-014-g11
server/services/admissions.ts.pre-ge-rmp-014-g7
...
server/services/notifications.ts.pre-ge-rmp-014
server/services/notifications.ts.pre-ge-rmp-014-g4
server/services/supabase-auth.ts
server/services/supabase-hub.ts
server/services/youtube-transcript.ts
server/static.ts
server/storage.ts
...
web/src/assets/qr/Whatsapp.jpg
web/src/assets/qr/zalo.jpg
...
web/src/growth/hooks/useJourneyPreference.ts
...
web/src/growth/pages/Landing/index.ts
...
This inspection establishes the implementation inventory.
Implementation priorities must be derived from repository evidence.
